<template>
  <nav class="flex items-center justify-between flex-wrap bg-padua shadow-md p-6 z-20">
    ...
    <div class="flex justify-end">
      ...
      <transition name="slide-fade">
        <div v-if="isActive" class="bg-padua absolute inset-0 w-64 py-12 shadow-lg slide-menu z-10">
